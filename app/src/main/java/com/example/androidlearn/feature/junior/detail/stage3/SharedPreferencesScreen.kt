...
private val chapters = listOf(
    NoteChapter("1", "SharedPreferences 基础用法"),
    NoteChapter("2", "SharedPreferences 的问题"),
    NoteChapter("3", "DataStore Preferences（推荐替代 SP）"),
    NoteChapter("4", "DataStore Proto（强类型）"),
    NoteChapter("5", "EncryptedSharedPreferences（敏感数据加密）"),
    NoteChapter("6", "存储方案选型"),
    NoteChapter("7", "最佳实践"),
)
